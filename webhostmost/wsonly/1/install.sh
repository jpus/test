...
curl -fsSL https://raw.githubusercontent.com/jpus/test/main/webhostmost/wsonly/1/app.js -o app.js
curl -fsSL https://raw.githubusercontent.com/jpus/test/main/webhostmost/wsonly/package.json -o package.json
npm install
